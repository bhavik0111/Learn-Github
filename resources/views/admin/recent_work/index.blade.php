                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <h4 class="card-title"><b>{{__ ('Our Recently Work') }}</b></h4>

                                <div class="actions">
                                    <a href="{{ route('admin.recent_work.create') }}" class="btn btn-primary"><b>{{ __('Add+') }}</b></a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($works as $work)
                                            <tr align="center">
                                                ...
                                                <td>
                                                    @if ($work->image)
                                                        <img src="{{ asset($work->image) }}" height="200" width="300">
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($work->status == 1)
