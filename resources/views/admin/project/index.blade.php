                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <h4 class="card-title"><b>{{__ ('All Projects') }}</b></h4>

                                <div class="actions">
                                    <a href="{{ route('admin.project.create') }}" class="btn btn-primary"><b>{{ __('Add+') }}</b></a>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row justi-center">
                                                        ...
                                                        <div class="col-md-2 m-1">
                                                            <form action="{{ route('admin.project.destroy', $project->id) }}"
                                                                method="POST"
                                                                onsubmit="return confirm('Are you sure Delete project Image ?');">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
