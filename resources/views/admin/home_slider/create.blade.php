                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                <h4 class="card-title"><b>{{ __('Add Home Slider Image') }}</b></h4>
                                <div class="actions">
                            ...
                            <div class="card-body">
                                <form method="POST"action="{{ route('admin.home_slider.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="file" name="image" accept="image/png, image/gif, image/jpeg, image/jpg" class="form-control @error('image') is-invalid @enderror"
