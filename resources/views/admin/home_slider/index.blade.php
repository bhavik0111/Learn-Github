                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <h4 class="card-title"><b>{{__ ('Home Slider Images') }}</b></h4>

                                <div class="actions">
                                    <a href="{{ route('admin.home_slider.create') }}" class="btn btn-primary"><b>{{ __('Add+') }}</b></a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($sliders as $slider)
                                            <tr align="center">
                                                ...
                                                <td>
                                                    @if ($slider->image)
                                                        <img src="{{ asset($slider->image) }}" height="200" width="300">
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($slider->status == 1)
                                                ...
                                                <td>
                                                    <div class="row justi-center">
                                                        <div class="col-md-2 m-1">
                                                            <a href="{{ route('admin.home_slider.edit', $slider->id) }}"
                                                                class="btn btn-warning"><b><i class="fa fa-edit"></i></b>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-2 m-1">
                                                            <form action="{{ route('admin.home_slider.destroy', $slider->id) }}"
                                                                method="POST"
                                                                onsubmit="return confirm('Are you sure Delete Home Slider Image ?');">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
