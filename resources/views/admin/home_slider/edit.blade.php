                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                <h4 class="card-title"><b>{{__ ('Edit Slider Image') }}</b></h4>
                                <div class="actions">
                                    <a href="{{ route('admin.home_slider.index') }}" class="btn btn-primary"><b>
                                            {{ __('Back') }}</b></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.home_slider.update', $slider->id) }}"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                                value="{{ old('title', $slider->title) }}" autofocus>
                                            @error('title')
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            <textarea name="description" class="form-control  @error('description') is-invalid @enderror" placeholder="description" autofocus>{{ old('description', $slider->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            ...
                                            @if ($slider->image)
                                                <img src="{{ asset($slider->image) }}" height="300" width="450">
                                            @endif
                                        ...
                                        <div class="col-1">
                                            <label class="form-check form-check-inline">
                                                <input type="radio" name="status" class="form-check-input" value="1"
                                                    required {{ $slider->status == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-1">
                                            <label class="form-check form-check-inline">
                                                <input type="radio" name="status" class="form-check-input" value="0"
                                                    required {{ $slider->status == 0 ? 'checked' : '' }}>
